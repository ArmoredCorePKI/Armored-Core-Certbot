...
class NamespaceConfig:
    ...
    @property
    def verify_puf_cert(self) -> bool:
        """List of user specified preferred challenges.

        Sorted with the most preferred challenge listed first.
        """
        return self.namespace.verify_puf_cert
    ...
    def test_domain(self) -> str:
        """The test domain specified by the developer, e.g. mydomain.test
        """
        return self.namespace.test_domain
