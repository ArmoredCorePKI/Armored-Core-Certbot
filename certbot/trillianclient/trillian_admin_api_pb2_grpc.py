...
class TrillianAdmin(object):
    ...
    def ListTrees(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/ListTrees',
            trillian__admin__api__pb2.ListTreesRequest.SerializeToString,
            trillian__admin__api__pb2.ListTreesResponse.FromString,
    ...
    def GetTree(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/GetTree',
            trillian__admin__api__pb2.GetTreeRequest.SerializeToString,
            trillian__pb2.Tree.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateTree(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/CreateTree',
            trillian__admin__api__pb2.CreateTreeRequest.SerializeToString,
            trillian__pb2.Tree.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateTree(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/UpdateTree',
            trillian__admin__api__pb2.UpdateTreeRequest.SerializeToString,
            trillian__pb2.Tree.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteTree(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/DeleteTree',
            trillian__admin__api__pb2.DeleteTreeRequest.SerializeToString,
            trillian__pb2.Tree.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UndeleteTree(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/trillian.TrillianAdmin/UndeleteTree',
            trillian__admin__api__pb2.UndeleteTreeRequest.SerializeToString,
            trillian__pb2.Tree.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
